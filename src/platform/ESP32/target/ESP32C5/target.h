...
// Build-target skeleton for ESP32-C5 (RISC-V, single core, dual-band Wi-Fi 6).
...
// ESP32-C5 only has USB Serial/JTAG (no OTG); USB VCP driver not yet ported.
#undef USE_VCP
...
// GDMA is present on C5 but the driver layer hasn't been ported.
#undef USE_DMA
#undef USE_DMA_SPEC
