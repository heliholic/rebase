 ...
 * ROTORFLIGHT
 *
 * Variable-order expo for helicopter applications. sRates[axis] (0-100) controls
 * the expo curve shape; higher values give more aggressive response at stick edges.
 */
