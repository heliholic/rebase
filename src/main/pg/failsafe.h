...
typedef struct {
    ...
    failsafeSwitchMode_e failsafe_switch_mode; // failsafe switch action is 0: Stage 1, 1: Disarms instantly, 2: Stage 2
    failsafeProcedure_e failsafe_procedure; // selected full failsafe procedure is 0: auto-landing, 1: Drop it
