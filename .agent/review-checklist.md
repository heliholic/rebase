...
- [ ] New files have the Rotorflight GPL3 copyright header from `src/main/common/header.h`
...
- [ ] CLI command changes (add, remove, rename, default change) documented in `Releases.md`
- [ ] MSP protocol changes documented in `Releases.md`
- [ ] Default configuration value changes documented in `Releases.md`
